package com.example.CrudVentas.offices.controller;



import com.example.CrudVentas.offices.model.Offices;
import com.example.CrudVentas.offices.model.OfficesDAO;
...
public class Service {
    ...
    public List<Offices> getOffices(){
        return new OfficesDAO().findAllOffices();
    }
    ...
    public Offices getOffices(@PathParam("id") String officeCode){ //CONSULTA POR ID
        return new OfficesDAO().findOfficeById(officeCode);
    }
    ...
    public Offices save(MultivaluedMap<String, String> formParams){
        ...
        if(new OfficesDAO().insertOffice(getParams(officeCode, formParams), true))
            return new OfficesDAO().findOfficeById(officeCode);
        return null;
    }
    ...
    public Offices save(@PathParam("id") String officeCode, MultivaluedMap<String, String> formParams){
        if(new OfficesDAO().insertOffice(getParams(officeCode, formParams), false))
            return new OfficesDAO().findOfficeById(officeCode);
        return null;
    }
    ...
    public boolean delete(@PathParam("id") String officeCode){
        return new OfficesDAO().deleteOffice(officeCode);
    }
